...
NS_LOG_COMPONENT_DEFINE ("NrMacSchedulerUeInfoPG");

void NrMacSchedulerUeInfoPG::UpdateDlPGMetric (const NrMacSchedulerNs3::FTResources &totAssigned,
...
void NrMacSchedulerUeInfoPG::UpdateUlPGMetric (const NrMacSchedulerNs3::FTResources &totAssigned,
                                               const Ptr<const NrAmc> &amc)
{
  NS_LOG_FUNCTION (this);
...
// void NrMacSchedulerUeInfoPG::CalculatePotentialTPutDl (const NrMacSchedulerNs3::FTResources &assignableInIteration,
//                                                        const Ptr<const NrAmc> &amc)
// {
//   NS_LOG_FUNCTION (this);
...
// void NrMacSchedulerUeInfoPG::CalculatePotentialTPutUl (const NrMacSchedulerNs3::FTResources &assignableInIteration,
//                                                        const Ptr<const NrAmc> &amc)
// {
//   NS_LOG_FUNCTION (this);
